...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    public DlgKamarInap(java.awt.Frame parent, boolean modal) {
        ...
        PenangungJawab.setDocument(new batasInput((int)100).getKata(PenangungJawab));
    ...
    private void initComponents() {
        ...
        PenangungJawab = new widget.TextBox();
        WindowDiagnosaAkhir1 = new javax.swing.JDialog();
        ...
        internalFrame10.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ganti Penangung Jawab ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel41.setText("Penangung Jawab :");
        jLabel41.setName("jLabel41"); // NOI18N
        internalFrame10.add(jLabel41);
        jLabel41.setBounds(0, 32, 110, 23);

        PenangungJawab.setHighlighter(null);
        PenangungJawab.setName("PenangungJawab"); // NOI18N
        PenangungJawab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PenangungJawabActionPerformed(evt);
            }
        });
        PenangungJawab.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenangungJawabKeyPressed(evt);
            }
        });
        internalFrame10.add(PenangungJawab);
        PenangungJawab.setBounds(119, 32, 270, 23);

        WindowPenanggungJawab.getContentPane().add(internalFrame10, java.awt.BorderLayout.CENTER);

        WindowDiagnosaAkhir1.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowDiagnosaAkhir1.setName("WindowDiagnosaAkhir1"); // NOI18N
        WindowDiagnosaAkhir1.setUndecorated(true);
        WindowDiagnosaAkhir1.setResizable(false);
        ...
        internalFrame11.add(PenanggungJawab);
        PenanggungJawab.setBounds(99, 32, 290, 23);

        WindowDiagnosaAkhir1.getContentPane().add(internalFrame11, java.awt.BorderLayout.CENTER);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2021" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2021" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2021" }));
        ...
        TNoRw1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TNoRw1ActionPerformed(evt);
            }
        });
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void MnPenanggungJawabActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(norawat.getText().trim().equals("")){
    ...
    private void BtnSimpan7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan7ActionPerformed
        //edit nama penanggungjawab
        if(norawat.getText().trim().equals("")){
            Valid.textKosong(norawat,"No.Rawat");
        }else{
            Sequel.mengedit("kamar_inap","no_rawat=?"," p_jawab=?",2,new String[]{PenangungJawab.getText(),norawat.getText()});
            tampil();
            WindowPenanggungJawab.dispose();
        }
    }//GEN-LAST:event_BtnSimpan7ActionPerformed

    private void PenangungJawabKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenangungJawabKeyPressed
        Valid.pindah(evt, BtnCloseIn7, BtnSimpan7);
    }//GEN-LAST:event_PenangungJawabKeyPressed

    private void PenangungJawabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PenangungJawabActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PenangungJawabActionPerformed
    ...
    private void TNoRw1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TNoRw1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TNoRw1ActionPerformed
    ...
    */
    ...
    private widget.TextBox PenangungJawab;
    ...
    private javax.swing.JDialog WindowDiagnosaAkhir1;
