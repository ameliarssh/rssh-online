 ...
 * @author perpustakaan
 */
public class DlgKamarInap1 extends javax.swing.JDialog {
     ...
     * @param parent
       @param modal */
    public DlgKamarInap1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel41.setText("Diagnosa Akhir :");
        ...
        PenangungJawab.setBounds(99, 32, 290, 23);
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void BtnSimpan7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan7ActionPerformed
        ...
        if(norawat.getText().trim().equals("")){
            ...
            Sequel.mengedit("kamar_inap","no_rawat=?"," png_jawab=?",2,new String[]{DiagnosaAkhirSementara.getText(),norawat.getText()});
            tampil();
            WindowPenanggungJawab.dispose();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKamarInap1 dialog = new DlgKamarInap1(new javax.swing.JFrame(), true);
